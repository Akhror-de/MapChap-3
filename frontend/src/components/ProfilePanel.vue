        ...
        <div class="tab-content">
          ...
          <div v-if="activeTab === 'favorites'" class="favorites-tab">
            ...
            <div class="favorites-stats">
              ...
              <div class="stat-card">
                <div class="stat-value">{{ userStats.favoriteCategories || 0 }}</div>
                <div class="stat-label">Категорий</div>
              </div>
              <div class="stat-card">
                <div class="stat-value">{{ userStats.avgRating || '0.0' }}</div>
...
export default {
  ...
  setup() {
    ...
    const { updateUserProfile, getFavorites, removeFavorite } = profileStore
